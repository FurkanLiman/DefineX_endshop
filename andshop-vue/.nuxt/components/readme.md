...
- `<CartCanvas>` | `<cart-canvas>` (components/cart/CartCanvas.vue)
- `<HeaderAlt>` | `<header-alt>` (components/header/HeaderAlt.vue)
...
- `<ProductReviewSection>` | `<product-review-section>` (components/product/ReviewSection.vue)
